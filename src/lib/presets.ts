...
export const PRESETS: CinematicPreset[] = [
	...
	{
		id: 'breaking-bad',
		image: '/images/presets/breaking-bad.jpg',
		name: 'Breaking Bad',
		tagline: 'Yellow-green desert, gritty high contrast',
		genre: 'TV Shows',
		filter: 'contrast(1.3) saturate(0.95) brightness(0.98) sepia(0.22) hue-rotate(-8deg)',
		overlay: { type: 'linear', angle: 90, stops: ['#1a1c08', '#c2b23a'], blend: 'overlay', opacity: 0.38 },
		defaults: { grain: 24, vignette: 32, glow: 8 },
	},
	{
		id: 'better-call-saul',
		image: '/images/presets/better-call-saul.jpg',
		name: 'Better Call Saul',
		tagline: 'Warm desert tones, high contrast',
		genre: 'TV Shows',
		filter: 'contrast(1.28) saturate(1.1) brightness(1.02) sepia(0.2)',
		overlay: { type: 'linear', angle: 90, stops: ['#241a08', '#e8a94a'], blend: 'soft-light', opacity: 0.38 },
		defaults: { grain: 14, vignette: 22, glow: 14 },
	},
	{
		id: 'peaky-blinders',
		image: '/images/presets/peaky-blinders.jpg',
		name: 'Peaky Blinders',
		tagline: 'Dark, desaturated, vintage moody',
		genre: 'TV Shows',
		filter: 'contrast(1.24) saturate(0.5) brightness(0.82) sepia(0.1)',
		overlay: { type: 'linear', angle: 90, stops: ['#0a0c10', '#3a3428'], blend: 'overlay', opacity: 0.42 },
		defaults: { grain: 28, vignette: 46, glow: 6 },
	},
	{
		id: 'stranger-things',
		image: '/images/presets/stranger-things.jpg',
		name: 'Stranger Things',
		tagline: '80s neon, warm highlights, deep shadows',
		genre: 'TV Shows',
		filter: 'contrast(1.3) saturate(1.35) brightness(0.96)',
		overlay: { type: 'linear', angle: 90, stops: ['#1a0a2e', '#c2273d'], blend: 'overlay', opacity: 0.4 },
		haze: { color: '#ff3d6a', opacity: 0.08 },
		defaults: { grain: 22, vignette: 34, glow: 24 },
	},
	{
		id: 'game-of-thrones',
		image: '/images/presets/game-of-thrones.jpg',
		name: 'Game of Thrones',
		tagline: 'Cold, muted, epic fantasy',
		genre: 'TV Shows',
		filter: 'contrast(1.16) saturate(0.6) brightness(0.9)',
		overlay: { type: 'linear', angle: 90, stops: ['#0a0e14', '#3a4450'], blend: 'overlay', opacity: 0.36 },
		defaults: { grain: 18, vignette: 34, glow: 8 },
	},
	{
		id: 'the-last-of-us',
		image: '/images/presets/the-last-of-us.jpg',
		name: 'The Last of Us',
		tagline: 'Muted greens, earthy post-apocalyptic',
		genre: 'TV Shows',
		filter: 'contrast(1.2) saturate(0.62) brightness(0.9) sepia(0.1)',
		overlay: { type: 'linear', angle: 90, stops: ['#0e140a', '#4a5636'], blend: 'overlay', opacity: 0.38 },
		defaults: { grain: 26, vignette: 36, glow: 8 },
	},
	{
		id: 'euphoria',
		image: '/images/presets/euphoria.jpg',
		name: 'Euphoria',
		tagline: 'Neon dreamscape, purple-blue haze',
		genre: 'TV Shows',
		filter: 'contrast(1.15) saturate(1.4) brightness(1.02)',
		overlay: { type: 'linear', angle: 90, stops: ['#160a30', '#7a3dff'], blend: 'overlay', opacity: 0.4 },
		haze: { color: '#7a3dff', opacity: 0.1 },
		defaults: { grain: 10, vignette: 20, glow: 28 },
	},
	{
		id: 'the-walking-dead',
		image: '/images/presets/the-walking-dead.jpg',
		name: 'The Walking Dead',
		tagline: 'Desaturated, gritty, muted survival',
		genre: 'TV Shows',
		filter: 'contrast(1.22) saturate(0.5) brightness(0.88)',
		overlay: { type: 'linear', angle: 90, stops: ['#0e0e0c', '#40403a'], blend: 'overlay', opacity: 0.34 },
		defaults: { grain: 30, vignette: 38, glow: 6 },
	},
	{
		id: 'house-of-the-dragon',
		image: '/images/presets/house-of-the-dragon.jpg',
		name: 'House of the Dragon',
		tagline: 'Dark medieval, cool shadows',
		genre: 'TV Shows',
		filter: 'contrast(1.28) saturate(0.7) brightness(0.86)',
		overlay: { type: 'linear', angle: 90, stops: ['#08090c', '#3a4048'], blend: 'overlay', opacity: 0.4 },
		defaults: { grain: 18, vignette: 44, glow: 10 },
	},
	{
		id: 'dark',
		image: '/images/presets/dark.jpg',
		name: 'Dark',
		tagline: 'Extremely dark, blue-green moody',
		genre: 'TV Shows',
		filter: 'contrast(1.35) saturate(0.55) brightness(0.76)',
		overlay: { type: 'linear', angle: 90, stops: ['#020604', '#1e4a40'], blend: 'overlay', opacity: 0.46 },
		defaults: { grain: 20, vignette: 50, glow: 8 },
	},
];
